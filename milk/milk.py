...
# URL-кодировка маркировок
marks_url_encoded = [urllib.parse.quote(mark) for mark in marks]

# Сохранение маркировок в файл
with open("milkWithoutWight.txt", "w", encoding="utf-8") as file:
...
# Вывод результатов
print("Маркировки сохранены в файл 'milkWithoutWight.txt'")
